...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/authenticite`, changeFrequency: "monthly", priority: 0.4 },
    { url: `${SITE_URL}/contact`, changeFrequency: "monthly", priority: 0.4 },
    { url: `${SITE_URL}/aide`, changeFrequency: "monthly", priority: 0.4 },
    { url: `${SITE_URL}/paiement`, changeFrequency: "monthly", priority: 0.4 },
    { url: `${SITE_URL}/retours`, changeFrequency: "monthly", priority: 0.4 },
    { url: `${SITE_URL}/cgv`, changeFrequency: "monthly", priority: 0.3 },
    { url: `${SITE_URL}/confidentialite`, changeFrequency: "monthly", priority: 0.3 },
    { url: `${SITE_URL}/mentions-legales`, changeFrequency: "monthly", priority: 0.3 },
