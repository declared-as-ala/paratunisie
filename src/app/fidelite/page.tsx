...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/fidélite" },
  openGraph: { type: "website", title: "Le Cercle ParaTunisie | ParaTunisie", url: "/fidélite" },
};
...
export default function FidelitePage() {
  const jsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Le Cercle ParaTunisie", item: `${SITE_URL}/fidélite` },
    ],
  };
