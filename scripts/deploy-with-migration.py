...
commands = [
    ...
    "cd /opt/paratunisie/app && docker exec -i paratunisie-api npx prisma db push --accept-data-loss || true",
    "docker compose -f /opt/paratunisie/app/docker-compose.prod.yml build paratunisie-api paratunisie-web",
