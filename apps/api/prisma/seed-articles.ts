...
interface SeedArticleDef {
  ...
  canonicalUrl: string;
  productSlugs: { slug: string; rationale?: string }[];
  faqs: { question: string; answer: string }[];
  contentBlocks: any[];
}

const articlesData: SeedArticleDef[] = [
  {
    ...
    faqs: [
      {
        ...
        answer: "Creapure® est un label allemand breveté garantissant des contrôles stricts. Une créatine monohydrate pure de marque européenne certifiée offre une efficacité équivalente sur la force.",
      },
      {
        question: "Faut-il faire une phase de charge de 20g par jour ?",
        answer: "Non. Une dose de 3g à 5g par jour sature pleinement les réserves musculaires en 3 à 4 semaines.",
      },
    ],
    contentBlocks: [
  ...
  },
  {
    ...
    excerpt: "Guide et comparatif pour bien choisir votre booster pre-workout : formules avec ou sans caféine, dosages en citrulline, bêta-alanine et critères de sélection.",
    ...
    seoDescription: "Comment choisir le meilleur pre-workout selon vos objectifs ? Comparatif des formules avec ou sans caféine, dosages en citrulline, bêta-alanine et conseils d'utilisation.",
...
export async function seedArticles() {
  ...
  // 1. Archive or clean old articles
  const oldSlugs = [
  ...
  for (const item of articlesData) {
    ...
    // 3. Clear existing product & FAQ relations
